        ...
        {status === "done" ? (
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <label className="block text-sm font-medium">
                Telefone
                <input name="phone" type="tel" required inputMode="tel" autoComplete="tel" maxLength={25} value={phone} onChange={(e) => setPhone(formatPhone(e.target.value))} placeholder={PHONE_PLACEHOLDER} className={`${field}${phone && !isValidPhone(phone) ? " border-destructive ring-1 ring-destructive" : ""}`} aria-invalid={Boolean(phone) && !isValidPhone(phone)} />
