...
export const sourceHash = "1sd0fk5";
...
export const dict: Dict = {
    ...
    "items": [
      {
        ...
        "ai": {
          ...
          "items": [
            ...
            "Simulación de escenarios de precio, costo y capacidad antes de comprometer inversiones"
          ]
        },
        "deliverables": [
      ...
      },
      {
        ...
        "ai": {
          "body": "Brasil produce gran volumen de datos públicos en portugués. La IA nos permite procesar todo a escala y entregar conclusiones en el idioma del cliente.",
          "items": [
  ...
  "about": {
    ...
    "body2": "Trabajamos junto a empresas brasileñas que buscan crecer con método y empresas internacionales que necesitan entender Brasil antes de invertir. En todos los casos, entregamos claridad: qué hacer, en qué orden y cómo medirlo.",
    "values": [
      {
  ...
  "content": {
    ...
    "items": [
      ...
      },
      {
        ...
        "group": "operacoes",
        "kind": "Artículo",
        "title": "La rutina que sostiene el resultado tras el proyecto",
      ...
      },
      {
        ...
        "summary": "Lo que los datos del sistema revelan sobre cuellos de botella, retrabajos y desviaciones de estándar que la observación de campo no captura.",
      ...
      },
      {
        ...
        "summary": "Cómo estructurar el costo por cliente, por pedido y por canal para descubrir si el crecimiento aumenta o destruye el margen.",
  ...
  "careers": {
    ...
    "errorTooFast": "Envío muy rápido. Revise los datos e intente nuevamente.",
    "errorRate": "Demasiados envíos en poco tiempo. Intente nuevamente más tarde.",
    ...
    "errorGeneric": "No fue posible enviar ahora. Intente nuevamente en unos instantes.",
  ...
  "serviceDetail": {
    ...
    "form": {
      ...
      "body": "Complete los datos abajo y le responderemos en un máximo de dos días hábiles.",
      "name": "Nombre",
      "company": "Empresa",
      "country": "País",
    ...
    "pages": [
      ...
      },
      {
        ...
        "body": "Mapeamos la madurez digital de la empresa, elegimos dónde la tecnología genera retorno más rápido y conducimos la implantación junto con el equipo. Sistemas, datos y procesos comienzan a trabajar a favor de la decisión.",
      ...
      },
      {
        ...
        "ai": "La lectura automática de registros del sistema revela dónde se traba realmente el proceso, sin depender únicamente de entrevistas."
      },
      {
        "id": "excelencia-industrial",
        "group": "operacoes",
      ...
      },
      {
        ...
        "body": "Estructuramos propuesta de valor, público, canales, fuentes de ingresos y estructura de costos. Al final, el negocio tiene un modelo explícito, con las hipótesis críticas identificadas y listas para prueba.",
      ...
      },
      {
        ...
        "audience": "Negocios en etapa temprana (early stage) y nuevos productos antes de la inversión en escala.",
      ...
      },
      {
        ...
        "audience": "Negocios saliendo de validación y comenzando a vender de forma recurrente.",
      ...
      },
      {
        ...
        "body": "Mapeamos a los competidores relevantes: portafolio, precios, canales, posicionamiento y desempeño. Usted entra sabiendo contra quién compite y por dónde diferenciarse.",
      ...
      },
      {
        ...
        "body": "Mapeamos requisitos regulatorios, carga tributaria, licencias, normas laborales y barreras prácticas del sector. Entregamos el camino crítico y el costo real de cumplimiento.",
      ...
      },
      {
        ...
        "body": "Identificamos y calificamos distribuidores, proveedores, socios comerciales y objetivos de adquisición. Entregamos una shortlist con criterios objetivos y lectura de fit estratégico.",
        ...
        "ai": "Cruce automatizado de bases públicas y financieras acelera el filtrado de cientos de empresas a unas pocas decenas."
      }
    ]
  }
};
