...
export const KEYWORD_THEMES: KeywordTheme[] = [
  ...
  {
    id: "qualidade",
    title: "Qualidade, Lean Six Sigma e certificações",
    titleEn: "Quality, Lean Six Sigma and certifications",
    titleEs: "Calidad, Lean Six Sigma y certificaciones",
    titleZh: "质量、精益六西格玛与认证",
    terms: [
      {
        term: "consultoria ISO 9001",
        en: "ISO 9001 consulting",
        es: "consultoría ISO 9001",
        zh: "ISO 9001 咨询",
        path: "/services/diagnostico-de-qualidade-90",
      },
      {
        term: "preparação para certificação ISO 9001",
        en: "ISO 9001 certification readiness",
        es: "preparación para la certificación ISO 9001",
        zh: "ISO 9001 认证准备",
        path: "/services/diagnostico-de-qualidade-90",
      },
      {
        term: "diagnóstico de gestão da qualidade",
        en: "quality management assessment",
        es: "diagnóstico de gestión de la calidad",
        zh: "质量管理诊断",
        path: "/services/diagnostico-de-qualidade-90",
      },
      {
        term: "auditoria interna da qualidade",
        en: "internal quality audit",
        es: "auditoría interna de la calidad",
        zh: "内部质量审核",
        path: "/services/diagnostico-de-qualidade-90",
      },
      {
        term: "consultoria Lean Six Sigma",
        en: "Lean Six Sigma consulting",
        es: "consultoría Lean Six Sigma",
        zh: "精益六西格玛咨询",
        path: "/services/sprint-lean-six-sigma-de-resultado",
      },
      {
        term: "projeto DMAIC de melhoria contínua",
        en: "DMAIC continuous improvement project",
        es: "proyecto DMAIC de mejora continua",
        zh: "DMAIC 持续改进项目",
        path: "/services/sprint-lean-six-sigma-de-resultado",
      },
      {
        term: "redução de defeitos e retrabalho na produção",
        en: "defect and rework reduction in production",
        es: "reducción de defectos y retrabajo en la producción",
        zh: "生产缺陷与返工削减",
        path: "/services/sprint-lean-six-sigma-de-resultado",
      },
      {
        term: "treinamento Green Belt e Yellow Belt",
        en: "Green Belt and Yellow Belt training",
        es: "formación Green Belt y Yellow Belt",
        zh: "绿带与黄带培训",
        path: "/services/academia-de-qualidade-e-lean-para-certificacoes",
      },
      {
        term: "formação de auditor interno ISO 9001",
        en: "ISO 9001 internal auditor training",
        es: "formación de auditor interno ISO 9001",
        zh: "ISO 9001 内审员培训",
        path: "/services/academia-de-qualidade-e-lean-para-certificacoes",
      },
      {
        term: "academia de melhoria contínua para empresas",
        en: "continuous improvement academy for companies",
        es: "academia de mejora continua para empresas",
        zh: "企业持续改进学院",
        path: "/services/academia-de-qualidade-e-lean-para-certificacoes",
      },
    ],
