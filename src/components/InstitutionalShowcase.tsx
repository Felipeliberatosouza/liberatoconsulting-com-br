        ...
        <div className="grid overflow-hidden bg-ink text-ink-foreground lg:grid-cols-[1.1fr_0.9fr]">
          <div className="p-8 md:p-12">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
               <Link to="/ferramentas" search={{}} className="inline-flex items-center gap-2 rounded-full bg-accent px-6 py-3 text-sm font-semibold text-accent-foreground"><Download className="size-4" /> Ferramentas de gestão grátis</Link>
