...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      aria-label={label}
      title={title}
      className="fixed bottom-28 right-6 z-30 inline-flex size-14 items-center justify-center rounded-full bg-[#25D366] p-3 text-white shadow-lg transition-transform hover:scale-105 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
    >
      <svg
        viewBox="0 0 24 24"
